...
Je viens en renfort de vos équipes en gardant toujours en tête le problème que je cherche à résoudre et la valeur pour les utilisateurs : c'est ce qui guide les choix techniques, et non l'inverse. Je suis aussi à l'aise sur du code hérité que sur un projet parti de zéro : explorer et moderniser de vastes bases de code existantes comme livrer de nouveaux services dans des systèmes distribués à fort trafic, et rendre l'ensemble fiable et observable. La fiabilité est mon terrain de prédilection — j'ai été l'un des premiers à mettre en place les SLO et une démarche SRE dans plusieurs équipes — tout en restant attiré par les missions back-end plus généralistes.
